...
\title{\textbf{Reference, Summary, or KV Cache?}\\[1mm]
\textbf{\large Measuring How Multi-Agent Systems Should Share Context}\\[2mm]
\normalsize\textnormal{with TOAP, a reference-minimized protocol and its open implementation}}
