...
ax.set_title("Writer-stage tokens by context strategy (n=5 Haiku, n=3 Sonnet/Opus; error=min-max)")
...
ax.set_ylim(0, 4.6)
ax.set_title("Accuracy parity at n>1: all 9 cells score 4/4 (n=1 Haiku regression did not reproduce)")
